# Nocrato Health V2 — Guia de Onboarding e Testes

Este documento serve como referência completa para qualquer pessoa que precise testar, explorar ou onboarding no sistema Nocrato Health V2. Cobre credenciais, fluxos, endpoints, e cenários de teste end-to-end.
